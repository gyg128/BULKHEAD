...
deps_kernel/locking/lockdep.o := \
    ...
    $(wildcard include/config/DEBUG_LOCKDEP) \
    $(wildcard include/config/LOCKDEP_CIRCULAR_QUEUE_BITS) \
    $(wildcard include/config/TRACE_IRQFLAGS) \
    $(wildcard include/config/LOCKDEP_SMALL) \
    $(wildcard include/config/TRACE_IRQFLAGS_NMI) \
    $(wildcard include/config/PREEMPT_RT) \
    $(wildcard include/config/QUEUED_RWLOCKS) \
  ...
  kernel/locking/lockdep_internals.h \
    $(wildcard include/config/LOCKDEP_BITS) \
    $(wildcard include/config/LOCKDEP_CHAINS_BITS) \
    $(wildcard include/config/LOCKDEP_STACK_TRACE_BITS) \
    $(wildcard include/config/LOCKDEP_STACK_TRACE_HASH_BITS) \
...
kernel/locking/lockdep.o: $(wildcard ./tools/objtool/objtool)
#SYMVER lockdep_recursion 0xb3789337
#SYMVER lockdep_register_key 0x9009a26b
#SYMVER lockdep_init_map_type 0x3811d8f3
#SYMVER __lockdep_no_validate__ 0xe3297b2d
#SYMVER lock_set_class 0xceec7f93
#SYMVER lock_downgrade 0x1c7551a7
#SYMVER read_lock_is_recursive 0xfb7f0e96
#SYMVER lock_acquire 0x0709c929
#SYMVER lock_release 0x9af0a615
#SYMVER lock_is_held_type 0xb8fd7ce8
#SYMVER lock_pin_lock 0xb4468bbd
#SYMVER lock_repin_lock 0x1b830267
#SYMVER lock_unpin_lock 0x8677d6eb
#SYMVER lockdep_unregister_key 0x7d89af0f
#SYMVER debug_check_no_locks_freed 0xc624b289
#SYMVER debug_check_no_locks_held 0x0f6e1040
#SYMVER debug_show_all_locks 0x48c2ac2d
#SYMVER debug_show_held_locks 0xe7946bc4
#SYMVER lockdep_rcu_suspicious 0xae0bd7af
