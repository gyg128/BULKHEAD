...
deps_arch/x86/mm/sgtable.o := \
    ...
    $(wildcard include/config/PKS_HIT) \
  ...
  include/linux/pks.h \
    $(wildcard include/config/PKS_NF_TABLES) \
    $(wildcard include/config/PKS_LKM20) \
  arch/x86/include/asm/pks.h \
...
arch/x86/mm/sgtable.o: $(deps_arch/x86/mm/sgtable.o)

$(deps_arch/x86/mm/sgtable.o):

arch/x86/mm/sgtable.o: $(wildcard ./tools/objtool/objtool)
#SYMVER dm_zero_entry_gid 0x308e69ef
#SYMVER dm_zero_exit_gid 0xebe78c72
#SYMVER ipv6_entry_gid 0x2d3c2377
#SYMVER ipv6_exit_gid 0xeebd7062
#SYMVER register_switch_gate 0xe110498f
#SYMVER lookup_switch_gate 0x72fd2458
#SYMVER pstacks 0x0403e2e0
#SYMVER init_private_stacks 0xeee92c60
#SYMVER pks_switch 0x40d4ae5f
