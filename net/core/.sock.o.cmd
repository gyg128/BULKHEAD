...
#SYMVER sk_ns_capable 0x957298a5
#SYMVER sk_capable 0x72e4046d
#SYMVER sk_net_capable 0x482070a2
...
#SYMVER sk_set_memalloc 0xff39621a
#SYMVER sk_clear_memalloc 0x69bb65ed
#SYMVER __sk_backlog_rcv 0x5f74c681
#SYMVER sk_error_report 0xfd391fb6
#SYMVER sock_get_timeout 0xedd17b31
#SYMVER sock_copy_user_timeval 0x5bdb7603
#SYMVER __sock_queue_rcv_skb 0x82a3a660
#SYMVER sock_queue_rcv_skb_reason 0xb94fc549
#SYMVER __sk_receive_skb 0xd04fd6b5
#SYMVER __sk_dst_check 0x6e7319ef
#SYMVER sk_dst_check 0x65b8d003
#SYMVER sock_bindtoindex 0xa34c72ad
#SYMVER sk_mc_loop 0x261a8069
#SYMVER sock_set_reuseaddr 0xed8264a9
#SYMVER sock_set_reuseport 0x5c880a16
#SYMVER sock_no_linger 0x947437eb
#SYMVER sock_set_priority 0x803f8585
#SYMVER sock_set_sndtimeo 0xe0c69516
#SYMVER sock_enable_timestamps 0x7924f021
#SYMVER sock_set_keepalive 0x06623fe5
#SYMVER sock_set_rcvbuf 0xe5013a3f
#SYMVER sock_set_mark 0xab123c89
#SYMVER sockopt_lock_sock 0x7796d1b0
#SYMVER sockopt_release_sock 0xfe806adc
#SYMVER sockopt_ns_capable 0x2d89f92e
#SYMVER sockopt_capable 0x2a6a5aac
#SYMVER sock_setsockopt 0x854b8d62
#SYMVER sk_alloc 0x57437921
#SYMVER sk_free 0x1d077637
#SYMVER sk_clone_lock 0x52f04d15
#SYMVER sk_free_unlock_clone 0x4794cbb7
#SYMVER sk_setup_caps 0x0a0d8741
#SYMVER sock_wfree 0xf3f02094
#SYMVER skb_set_owner_w 0x5029d3e5
#SYMVER skb_orphan_partial 0xd3446d45
#SYMVER sock_rfree 0xf082cef6
#SYMVER sock_efree 0x4ab7d09f
#SYMVER sock_pfree 0x2a29f448
#SYMVER sock_i_uid 0xf37d1344
#SYMVER sock_i_ino 0x84b73785
#SYMVER sock_wmalloc 0x2d633c18
#SYMVER sock_kmalloc 0xc5fd0a24
#SYMVER sock_kfree_s 0x4c242cd3
#SYMVER sock_kzfree_s 0xfa53a592
#SYMVER sock_alloc_send_pskb 0xd978d188
#SYMVER __sock_cmsg_send 0x79ede2c0
#SYMVER sock_cmsg_send 0xb00bd4b0
#SYMVER skb_page_frag_refill 0xc2aedac2
#SYMVER sk_page_frag_refill 0x0155cf31
#SYMVER __sk_flush_backlog 0x7557b4bc
#SYMVER sk_wait_data 0x8d110e51
#SYMVER __sk_mem_schedule 0x185df1bf
#SYMVER __sk_mem_reclaim 0xfcc2644b
#SYMVER sk_set_peek_off 0x67f5ba46
#SYMVER sock_no_bind 0x33db666c
#SYMVER sock_no_connect 0x42ac3e4f
#SYMVER sock_no_socketpair 0x0f76ee09
#SYMVER sock_no_accept 0xacb6dfb9
#SYMVER sock_no_getname 0xf4a4a9d1
#SYMVER sock_no_ioctl 0x78817a81
#SYMVER sock_no_listen 0xf8062d6c
#SYMVER sock_no_shutdown 0x7f06ccda
#SYMVER sock_no_sendmsg 0x7fa24bdc
#SYMVER sock_no_sendmsg_locked 0x1dcda887
#SYMVER sock_no_recvmsg 0xa3957d08
#SYMVER sock_no_mmap 0x41cd039c
#SYMVER sock_no_sendpage 0x943a6c74
#SYMVER sock_no_sendpage_locked 0xf5023b6d
#SYMVER sk_send_sigurg 0xc86cd398
#SYMVER sk_reset_timer 0x573180c9
#SYMVER sk_stop_timer 0xea72ac76
#SYMVER sk_stop_timer_sync 0xf70c1032
#SYMVER sock_init_data 0xcbac34c3
#SYMVER lock_sock_nested 0xddbf82e7
#SYMVER release_sock 0xc9c8d5c9
#SYMVER __lock_sock_fast 0x7fb4c503
#SYMVER sock_gettstamp 0xfe1860ab
#SYMVER sock_recv_errqueue 0xc2a6d0d8
#SYMVER sock_common_getsockopt 0x360d3a0f
#SYMVER sock_common_recvmsg 0xb5e7dd67
#SYMVER sock_common_setsockopt 0x82b2b9de
#SYMVER sk_common_release 0x2a75147c
#SYMVER sock_prot_inuse_get 0x5fe0e7b3
#SYMVER sock_inuse_get 0x0149070c
#SYMVER proto_register 0x05295577
#SYMVER proto_unregister 0xe26905d9
#SYMVER sock_load_diag_module 0xf665f74f
#SYMVER sk_busy_loop_end 0xe590dea3
#SYMVER sock_bind_add 0x67d39289
