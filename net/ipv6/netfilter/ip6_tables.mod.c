...
SYMBOL_CRC(ip6t_alloc_initial_table, 0x883cf3c0, "_gpl");
SYMBOL_CRC(ip6t_register_table, 0x9352adc1, "");
SYMBOL_CRC(ip6t_unregister_table_pre_exit, 0xe90913d8, "");
SYMBOL_CRC(ip6t_unregister_table_exit, 0x9d52808d, "");
SYMBOL_CRC(ip6t_do_table, 0xf0f366ad, "");
