...
#SYMVER eth_header 0xbea15ad1
#SYMVER eth_get_headlen 0x8a48818c
#SYMVER eth_type_trans 0x78406a5d
#SYMVER eth_header_parse 0xb11727d4
#SYMVER eth_header_cache 0x797fcf8d
#SYMVER eth_header_cache_update 0x26433528
#SYMVER eth_header_parse_protocol 0xdf0d1f81
#SYMVER eth_prepare_mac_addr_change 0x03b6b32b
#SYMVER eth_commit_mac_addr_change 0x743d6fd1
#SYMVER eth_mac_addr 0xa808329d
#SYMVER eth_validate_addr 0x5528a9d0
#SYMVER ether_setup 0xf6e438e0
#SYMVER alloc_etherdev_mqs 0x3db88351
#SYMVER sysfs_format_mac 0x81533963
#SYMVER eth_gro_receive 0x571953b8
#SYMVER eth_gro_complete 0x1cda52ef
#SYMVER eth_platform_get_mac_address 0x3e750213
#SYMVER platform_get_ethdev_address 0x0d8d201c
#SYMVER fwnode_get_mac_address 0x5b27d737
#SYMVER device_get_mac_address 0x48f54acb
#SYMVER device_get_ethdev_address 0xe5cbae40
