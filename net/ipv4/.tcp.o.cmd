...
#SYMVER tcp_sockets_allocated 0x202bca9a
#SYMVER tcp_memory_pressure 0xc2a814db
#SYMVER tcp_enter_memory_pressure 0x2631738d
#SYMVER tcp_leave_memory_pressure 0x9f2ea354
#SYMVER tcp_init_sock 0x4999b4ed
#SYMVER tcp_poll 0x52768da1
#SYMVER tcp_ioctl 0xa572d101
#SYMVER tcp_splice_read 0x6a24b6e6
#SYMVER do_tcp_sendpages 0x1216d375
#SYMVER tcp_sendpage_locked 0x26836223
#SYMVER tcp_sendpage 0x0f89e48f
#SYMVER tcp_sendmsg_locked 0xe73b4920
#SYMVER tcp_sendmsg 0xc4f75566
#SYMVER tcp_recv_skb 0xbdc77863
#SYMVER tcp_read_sock 0xee436a6a
#SYMVER tcp_read_skb 0x5aa43a54
#SYMVER tcp_read_done 0x78ed1cb3
#SYMVER tcp_peek_len 0x36c676b0
#SYMVER tcp_set_rcvlowat 0x772edc02
#SYMVER tcp_mmap 0x5778f277
#SYMVER tcp_recvmsg 0x87a9e643
#SYMVER tcp_set_state 0x8ba34c31
#SYMVER tcp_shutdown 0x120b8cda
#SYMVER tcp_close 0x45beb447
#SYMVER tcp_disconnect 0xf5f414d0
#SYMVER tcp_tx_delay_enabled 0x14c67e3e
#SYMVER tcp_sock_set_cork 0x6383a845
#SYMVER tcp_sock_set_nodelay 0x7883ac3d
#SYMVER tcp_sock_set_quickack 0xa21d38bc
#SYMVER tcp_sock_set_syncnt 0x4454d290
#SYMVER tcp_sock_set_user_timeout 0xcc4626c4
#SYMVER tcp_sock_set_keepidle 0x588bad7b
#SYMVER tcp_sock_set_keepintvl 0xacb45320
#SYMVER tcp_sock_set_keepcnt 0x460a9b2a
#SYMVER tcp_setsockopt 0x2ef5a457
#SYMVER tcp_get_info 0x9567fa76
#SYMVER tcp_bpf_bypass_getsockopt 0xffcc4ec7
#SYMVER tcp_getsockopt 0x6eae7fe0
#SYMVER tcp_alloc_md5sig_pool 0x204c19f5
#SYMVER tcp_get_md5sig_pool 0xcfa589f8
#SYMVER tcp_md5_hash_skb_data 0x52909f25
#SYMVER tcp_md5_hash_key 0x74790317
#SYMVER tcp_inbound_md5_hash 0x9c2b588d
#SYMVER tcp_done 0xd37f5a0e
#SYMVER tcp_abort 0x1bd0fcac
