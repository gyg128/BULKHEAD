cmd_drivers/firmware/efi/libstub/x86-stub.o := clang -Wp,-MMD,drivers/firmware/efi/libstub/.x86-stub.o.d -nostdinc -I./arch/x86/include -I./arch/x86/include/generated  -I./include -I./arch/x86/include/uapi -I./arch/x86/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/compiler-version.h -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -Qunused-arguments -fmacro-prefix-map=./= -mcmodel=small -m64 -D__KERNEL__ -fPIC -fno-strict-aliasing -mno-red-zone -mno-mmx -mno-sse -fshort-wchar -Wno-pointer-sign -Wno-address-of-packed-member -Wno-gnu -fno-asynchronous-unwind-tables --target=x86_64-linux-gnu -fintegrated-as -Werror=unknown-warning-option -Werror=ignored-optimization-argument -Os -DDISABLE_BRANCH_PROFILING -include ./include/linux/hidden.h -D__NO_FORTIFY -ffreestanding -fno-stack-protector -fno-addrsig -D__DISABLE_EXPORTS     -DKBUILD_MODFILE='"drivers/firmware/efi/libstub/x86-stub"' -DKBUILD_BASENAME='"x86_stub"' -DKBUILD_MODNAME='"x86_stub"' -D__KBUILD_MODNAME=kmod_x86_stub -c -o drivers/firmware/efi/libstub/x86-stub.o drivers/firmware/efi/libstub/x86-stub.c  
