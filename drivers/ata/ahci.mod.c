...
__used __section("__versions") = {
	...
	{ 0x3d3cb059, "sysfs_add_file_to_group" },
	...
	{ 0x9b555c8c, "pm_suspend_default_s2idle" },
	...
	{ 0xb5e9629e, "ata_dev_next" },
	{ 0xa1bbd8b4, "_dev_err" },
	{ 0x87a21cb3, "__ubsan_handle_out_of_bounds" },
	{ 0xebfbcab8, "__stack_chk_fail" },
	{ 0xcd4782ea, "__dynamic_dev_dbg" },
	{ 0xc502ed45, "sysfs_remove_file_from_group" },
	{ 0x111d4ffd, "ata_pci_remove_one" },
	{ 0x50c9e9c3, "ata_pci_shutdown_one" },
...
MODULE_INFO(srcversion, "3B7D851892452611AD1F269");
