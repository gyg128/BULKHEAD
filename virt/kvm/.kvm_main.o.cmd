...
#SYMVER kvm_debugfs_dir 0xa1d87bde
#SYMVER kvm_rebooting 0x485cd7f6
#SYMVER vcpu_load 0x96717190
#SYMVER vcpu_put 0x2cd9f1cd
#SYMVER kvm_make_all_cpus_request 0x488b23d8
#SYMVER kvm_flush_remote_tlbs 0xd34f0070
#SYMVER kvm_destroy_vcpus 0xd543d2a7
#SYMVER kvm_get_kvm 0xf94ee064
#SYMVER kvm_get_kvm_safe 0xfa25873e
#SYMVER kvm_put_kvm 0x64842b56
#SYMVER kvm_put_kvm_no_destroy 0x9069d301
#SYMVER __kvm_set_memory_region 0x19209113
#SYMVER kvm_set_memory_region 0xc7b7a8f5
#SYMVER gfn_to_memslot 0x4ba44d5c
#SYMVER kvm_is_visible_gfn 0xae8a57a6
#SYMVER kvm_vcpu_is_visible_gfn 0xbb2f488c
#SYMVER gfn_to_hva_memslot 0xb332b817
#SYMVER gfn_to_hva 0xf63c74c5
#SYMVER kvm_vcpu_gfn_to_hva 0xb7965735
#SYMVER __gfn_to_pfn_memslot 0xcdbb177d
#SYMVER gfn_to_pfn_prot 0xc994fae7
#SYMVER gfn_to_pfn_memslot 0x67544a0a
#SYMVER gfn_to_pfn_memslot_atomic 0xea1814cd
#SYMVER kvm_vcpu_gfn_to_pfn_atomic 0x4f77fce8
#SYMVER gfn_to_pfn 0x9ceb417f
#SYMVER kvm_vcpu_gfn_to_pfn 0x5a123d54
#SYMVER gfn_to_page_many_atomic 0x77fdacf8
#SYMVER gfn_to_page 0x42a3b309
#SYMVER kvm_vcpu_map 0x2f833c0a
#SYMVER kvm_vcpu_unmap 0x71768d5e
#SYMVER kvm_release_page_clean 0x5c8ea842
#SYMVER kvm_release_pfn_clean 0x4e3fd1b4
#SYMVER kvm_release_page_dirty 0x52e1c923
#SYMVER kvm_release_pfn_dirty 0x7c94c99a
#SYMVER kvm_set_pfn_dirty 0xa1c4231f
#SYMVER kvm_set_pfn_accessed 0x6892e3c3
#SYMVER kvm_read_guest_page 0x31a8d7b4
#SYMVER kvm_vcpu_read_guest_page 0x3cd9c3f3
#SYMVER kvm_read_guest 0x98c6aa96
#SYMVER kvm_vcpu_read_guest 0x0c1560f0
#SYMVER kvm_vcpu_read_guest_atomic 0x841fb7d5
#SYMVER kvm_write_guest_page 0x594f8659
#SYMVER kvm_vcpu_write_guest_page 0x679571d0
#SYMVER kvm_write_guest 0x45f9c2fb
#SYMVER kvm_vcpu_write_guest 0x97bfb2c1
#SYMVER kvm_gfn_to_hva_cache_init 0xe38a5af6
#SYMVER kvm_write_guest_offset_cached 0xcf04fab3
#SYMVER kvm_write_guest_cached 0x75869e39
#SYMVER kvm_read_guest_offset_cached 0x5fe6bd7e
#SYMVER kvm_read_guest_cached 0xa859cd3e
#SYMVER kvm_clear_guest 0xd08d002d
#SYMVER mark_page_dirty_in_slot 0x9afe678e
#SYMVER mark_page_dirty 0xaf7d404b
#SYMVER kvm_vcpu_mark_page_dirty 0x157477d9
#SYMVER kvm_vcpu_halt 0xe07f4da1
#SYMVER kvm_vcpu_wake_up 0x3b5ba3c3
#SYMVER kvm_vcpu_kick 0x3dbd9c3c
#SYMVER kvm_vcpu_yield_to 0x50139d02
#SYMVER kvm_vcpu_on_spin 0x2d5f616c
#SYMVER file_is_kvm 0x4eaf147d
#SYMVER kvm_io_bus_write 0x36746d96
#SYMVER kvm_io_bus_get_dev 0x67d5c00d
#SYMVER kvm_get_running_vcpu 0x21d00dc4
#SYMVER kvm_init 0x9c0504b8
