...
#define PTREGS_AUX_SIZE 8 /* sizeof(struct pt_regs_extended) - sizeof(struct pt_regs) */

#define TASK_threadsp 7704 /* offsetof(struct task_struct, thread.sp) */
#define TASK_stack_canary 2416 /* offsetof(struct task_struct, stack_canary) */
